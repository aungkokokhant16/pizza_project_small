...
@section("content")
    <div class="container">
        <h1 class="gray-text mt-4 d-inline">Welcom From My Pizza Order Project</h1>
        <img src="{{asset('images/images.png')}}" width="400px" height="300px" class="img-responsive mt-4" alt="">
        @if (Session("success"))
